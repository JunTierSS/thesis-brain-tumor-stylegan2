...
% NOMBRE DE OBJETOS
\def\nameabstract {Abstract}                     % Name of the abstract
\def\nameagradec {Acknowledgements}             % Name of the acknowledgements section
\def\nameappendixsection {Annex}                % Name of the appendix section
\def\namechapter {Chapter}                      % Name of chapters
\def\nameltappendixsection {Annex}              % Label for appendix sections
\def\nameltcont{Table of Content}               % Name of the table of contents
\def\namelteqn {List of Equations}              % Name of the list of equations
\def\nameltfigure{List of Figures}              % Name of the list of figures
\def\nameltsrc {List of Code Listings}          % Name of the list of code
\def\namelttable {List of Tables}               % Name of the list of tables
\def\nameltwfigure {Figure}                     % Figure caption label
\def\nameltwsrc {Code}                          % Source code caption label
\def\nameltwtable {Table}                       % Table caption label
\def\namemathcol {Corollary}                    % Name of corollaries
\def\namemathdefn {Definition}                  % Name of definitions
\def\namemathej {Example}                       % Name of examples
\def\namemathlem {Lemma}                        % Name of lemmas
\def\namemathobs {Remark}                       % Name of remarks
\def\namemathprp {Proposition}                  % Name of propositions
\def\namemaththeorem {Theorem}                  % Name of theorems
\def\namepageof { of }                          % Label for page x of y
\def\nameportraitpage {Cover}                   % Label for cover page
\def\namereferences {Bibliograf\'ia}             % Name of the references section
