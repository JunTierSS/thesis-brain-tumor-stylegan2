...
The Hugging Face version (~7.4GB) includes everything in this GitHub repo plus:
...
The following large files are not included in this repository but can be regenerated:

| Data | Size | How to obtain |
|---|---|---|
| Full original dataset images | ~10GB | Download the original public brain tumor MRI dataset |
| `synth_CAS/` (CAS synthetic images) | 22GB | Run `08_exp2c_ablation_cas_scoring.ipynb` |
| `xai_batch_testset/` (full XAI outputs) | 4.3GB | Run `03_exp2a_counterfactual_inference.ipynb` |
| K-Fold intermediate results | ~44GB | Run experiment notebooks 05-10 |
